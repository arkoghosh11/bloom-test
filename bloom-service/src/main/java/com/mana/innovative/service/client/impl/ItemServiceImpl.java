...
public class ItemServiceImpl implements ItemService {
	...
	@Override
	@Transactional( propagation = Propagation.REQUIRED, readOnly = true, isolation = Isolation.DEFAULT )
	public Response getItemByItemName( final String itemName, final RequestParams requestParams ) {

		logger.debug( "Initiating getItemByItemName for item_name = " + itemName + " , itemDAO injected successfully" );
		...
		try {
			itemDAOResponse = itemDAOImpl.getItemByItemName( itemName, requestParams );
		...
		try {
			...
			logger.debug( " Response for getItemByItemName sent Successfully " );
		}
	}
