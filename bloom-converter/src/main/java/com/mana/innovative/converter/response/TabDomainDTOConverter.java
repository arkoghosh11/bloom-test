...
public class TabDomainDTOConverter {
    ...
    public static Tab getConvertedDTOFromDomain( Tab tabDTO, com.mana.innovative.domain.common.Tab tabDomain ) {
        ...
        tabDTO.setTabColor( tabDomain.getTabColor( ) );
        tabDTO.setTabPosition( tabDomain.getTabPosition( ) );
//            tab.setShopTab();
        return tabDTO;
    }
    ...
    public static com.mana.innovative.domain.common.Tab getConvertedDomainFromDTO( com.mana.innovative.domain.common.Tab tabDomain, Tab tabDTO ) {
        ...
        if ( !StringUtils.isEmpty( tabDTO.getTabColor( ) ) ) {
            tabDomain.setTabColor( tabDTO.getTabColor( ) );
        } else tabDomain.setTabContent( ServiceConstants.DEFAULT_TAB_COLOR );
        if ( !StringUtils.isEmpty( tabDTO.getTabPosition( ) ) ) {
            tabDomain.setTabPosition( tabDTO.getTabPosition( ) );
        } else tabDomain.setTabContent( ServiceConstants.DEFAULT_TAB_POSITION );
