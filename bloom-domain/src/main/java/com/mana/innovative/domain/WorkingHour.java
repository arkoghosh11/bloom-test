...
public class WorkingHour {
    ...
    public boolean equals ( final Object o ) {
        ...
        if ( !day.equals( workingHour.day ) ) return false;
        if ( !endTime.equals( workingHour.endTime ) ) return false;
        if ( !shopWorkingHour.equals( workingHour.shopWorkingHour ) ) return false;
        if ( !startTime.equals( workingHour.startTime ) ) return false;
