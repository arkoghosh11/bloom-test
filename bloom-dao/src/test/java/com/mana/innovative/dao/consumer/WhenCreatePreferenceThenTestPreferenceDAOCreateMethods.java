...
public class WhenCreatePreferenceThenTestPreferenceDAOCreateMethods {

    /**
     * The constant logger.
     */
    private static final Logger logger = LoggerFactory.getLogger( WhenCreatePreferenceThenTestPreferenceDAOCreateMethods.class );
