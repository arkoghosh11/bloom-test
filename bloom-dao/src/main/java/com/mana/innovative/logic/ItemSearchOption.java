 ...
 * searchOrder, searchMatchType }*** searchParams is for the columns to be search against for values entered by user in
 * DB
 * searchConditions is for applying conditions to each pram above for the column search in DB search Order is the
 * column
