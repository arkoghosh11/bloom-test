...
public class ResetCacheFilter implements Filter {
     ...
     * <p/>
     * <p/>
     * The web container cannot place the filter into service if the init method either <ol> <li>Throws a
     ...
     * <p/>
     * <p/>
     * A typical implementation of this method would follow the following pattern: <ol> <li>Examine the request
     ...
     * object ( <code>chain.doFilter()</code>), <li><strong>or</strong> not pass on the request/response pair to the
