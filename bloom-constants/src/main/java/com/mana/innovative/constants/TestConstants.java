...
public class TestConstants {
    ...
    public static final boolean TEST_IS_HOLIDAY = TEST_FALSE;
    public static final boolean TEST_IS_WEEKEND = TEST_FALSE;
    public static final boolean TEST_IS_CLOSED = TEST_FALSE;
